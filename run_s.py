...
import time
import config_s
from models.decomposed_vae_s import DecomposedVAE
import numpy as np
import random
...
def main(args):
    ...
    scripts_to_save = [
        'run.py', 'models/decomposed_vae_s.py', 'models/vae.py',
        'models/base_network.py', 'config_s.py']
...
def add_args(parser):
    ...
    parser.add_argument('--seed', type=int, default=2023, help='batch size for training')
