...
def calculate_gscore(refs,targets,confids):
    total_gscore = 0
...
def compute_bleu(reference_corpus, translation_corpus, max_order=4,
  ...
  gscore = [2*acc*p/(acc+p)  for acc, p in zip(acc_list,precisions)]


  return (bleu,gscore,precisions, bp, ratio, translation_length, reference_length)
